...
import static com.creadto.creadto_aos.camera.Renderer.particleData;
import static com.creadto.creadto_aos.camera.Renderer.frameData;
...
public final class PointCloudHelper {
    ...
    public static void convertImageToDepthAndColors(Image cameraImage, Image depthImage, Image confidenceImage,
        ...
        Image.Plane imagePlaneY = cameraImage.getPlanes()[0];
        Image.Plane imagePlaneU = cameraImage.getPlanes()[1];
        Image.Plane imagePlaneV = cameraImage.getPlanes()[2];
